...
const Sports = ({navigation, user_id}) => {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                {data.map((data)=>{
                    ...
                    return(
                        <Sports1 key={data.id} {...data} user_id={user_id}></Sports1>
                    )
                })}
                </View>
...
const Sports1 = ({title, author_name, created_at, time_at, image_url, body, category, user_id, id}) => {
