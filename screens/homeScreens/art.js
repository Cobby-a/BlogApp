        ...
        <View style={styles.container}>
            ...
            >
                ...
                {data.map((data)=>{
                    ...
                    return(
                        <Art1 key={data.id} {...data} user_id={user_id}></Art1>
                    )
                })}
                </View>
...
const Art1 = ({title, author_name, created_at, time_at, image_url, body, category, id, user_id}) => {
