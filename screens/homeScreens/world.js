...
const World = ({navigation, user_id}) => {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                {data.map((data)=>{
                    ...
                    return(
                        <World1 key={data.id} {...data} user_id={user_id}></World1>
                    )
                })}
                </View>
...
const World1 = ({title, author_name, created_at, time_at, image_url, body, category, user_id, id}) => {
