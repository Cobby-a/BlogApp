...
const Technology = ({navigation, user_id}) => {
        ...
        <View style={styles.container}>
            ...
            >
                ...
                {data.map((data)=>{
                    ...
                    return(
                        <Technology1 key={data.id} {...data} user_id={user_id}></Technology1>
                    )
                })}
                </View>
...
const Technology1 = ({title, author_name, created_at, time_at, image_url, body, category, id, user_id}) => {
